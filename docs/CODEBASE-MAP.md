...
| `components/challan/ChallanForm.tsx` | 490 | Create/edit/return form (parent owns save) | RPC `get_next_challan_number`; `cash_challans` recent, `cash_challan_customers` phone |
