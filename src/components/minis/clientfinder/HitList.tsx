...
const kindColor: Record<MatchKind, string> = { full: T.gr, partial: T.yl, page: T.tx3 };
const rank: Record<MatchKind, number> = { full: 0, partial: 1, page: 2 };

export default function HitList({ hits }: { hits: Hit[] }) {
