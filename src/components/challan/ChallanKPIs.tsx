  ...
  return (
    <>
      <div className="challan-kpi-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, marginBottom: 12, fontSize: 11 }}>
        <div style={{ background: 'oklch(0.72 0.19 145 / .06)', border: '1px solid oklch(0.72 0.19 145 / .15)', borderRadius: 6, padding: '8px 10px' }}>
        ...
        <div style={{ background: 'oklch(0.63 0.22 25 / .06)', border: '1px solid oklch(0.63 0.22 25 / .15)', borderRadius: 6, padding: '8px 10px' }}>
      ...
      <div style={{ background: !isRefund ? 'oklch(0.55 0.22 265 / .06)' : 'oklch(0.63 0.22 25 / .06)', border: `1px solid ${!isRefund ? 'oklch(0.55 0.22 265 / .15)' : 'oklch(0.63 0.22 25 / .15)'}`, borderRadius: 8, padding: '10px 14px', marginBottom: 14, textAlign: 'center' }}>
