  ...
  const content = (
    <div className="challan-detail-overlay" style={mobile
      ...
      <div ref={scrollRef} className="challan-detail-modal" style={mobile
        ? { position: 'fixed', bottom: 0, left: 0, right: 0, background: T.bg, borderRadius: '16px 16px 0 0', padding: 0, maxHeight: '85dvh', overflowY: 'auto', WebkitOverflowScrolling: 'touch', animation: 'slideUp .25s ease both' }
