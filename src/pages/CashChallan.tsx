    ...
    <div style={{ fontFamily: T.sans, color: T.tx, padding: '14px 16px' }}>
      ...
      <div className="challan-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
        ...
        <div className="challan-nav-btns" style={{ display: 'flex', gap: 6 }}>
          ...
          <button className="desktop-only" onClick={() => { setShowModal(true); window.history.pushState({ view: 'challan-new' }, ''); }} style={{ padding: '4px 12px', borderRadius: 6, border: 'none', background: `linear-gradient(135deg, ${T.ac}dd, ${T.ac2}cc)`, color: '#fff', fontSize: 10, fontWeight: 600, cursor: 'pointer', boxShadow: '0 2px 8px rgba(99,102,241,.25)' }}>+ New</button>
        </div>
      </div>
