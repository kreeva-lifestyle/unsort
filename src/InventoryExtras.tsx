...
export default function InventoryExtras() {
  ...
  const btnGhost: React.CSSProperties = { padding: '5px 12px', borderRadius: 6, border: `1px solid ${T.bd2}`, cursor: 'pointer', fontSize: 11, fontWeight: 500, background: 'rgba(255,255,255,0.03)', color: T.tx2, fontFamily: T.sans };
  const overlay: React.CSSProperties = { position: 'fixed', inset: 0, background: 'rgba(0,0,0,.80)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 200, backdropFilter: 'blur(8px)', padding: 8 };
