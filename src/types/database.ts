...
export interface CashChallanPayment {
  ...
  /** Return-credit legs: the challan on the other side of the credit (sale ↔ return). */
...
// code. wrong_norm is generated (upper(btrim(wrong))) and is the upsert key.
export interface IndyaSkuMap {
  id: string;
  wrong: string;
  wrong_norm: string;
  correct: string;
