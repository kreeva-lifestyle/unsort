...
export const T = {
  ...
  ac80: oklchTint(0.55, 0.22, 265, 0.80),
  ac55: oklchTint(0.55, 0.22, 265, 0.33),
  ac44: oklchTint(0.55, 0.22, 265, 0.27),
  ac33: oklchTint(0.55, 0.22, 265, 0.20),
  ac22: oklchTint(0.55, 0.22, 265, 0.13),
  ac2cc: oklchTint(0.65, 0.18, 270, 0.80),
  ac2_55: oklchTint(0.65, 0.18, 270, 0.33),
  grCC: oklchTint(0.72, 0.19, 145, 0.80),
  gr88: oklchTint(0.72, 0.19, 145, 0.53),
  gr80: oklchTint(0.72, 0.19, 145, 0.50),
  gr66: oklchTint(0.72, 0.19, 145, 0.40),
  gr44: oklchTint(0.72, 0.19, 145, 0.27),
  gr33: oklchTint(0.72, 0.19, 145, 0.20),
  gr22: oklchTint(0.72, 0.19, 145, 0.13),
  gr15: oklchTint(0.72, 0.19, 145, 0.08),
  reCC: oklchTint(0.63, 0.22, 25, 0.80),
  reAA: oklchTint(0.63, 0.22, 25, 0.67),
  re44: oklchTint(0.63, 0.22, 25, 0.27),
  ylCC: oklchTint(0.78, 0.18, 75, 0.80),
  yl88: oklchTint(0.78, 0.18, 75, 0.53),
  yl22: oklchTint(0.78, 0.18, 75, 0.13),
  bl30: oklchTint(0.77, 0.14, 230, 0.19),
...
export const S = {
  ...
  btnPrimary: {
    ...
    color: '#fff', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 5,
